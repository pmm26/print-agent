...
export default function QueuePage() {
  ...
  const rows = useMemo(() => {
    ...
    for (const query of queues) if (query.data) result.push(...[query.data.activeRun, ...query.data.queuedRuns, ...query.data.retryPendingRuns, ...query.data.attentionRuns, ...query.data.recentTransmittedRuns].filter((run): run is PrintRun => !!run))
